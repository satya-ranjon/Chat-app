...
export default function FbprofileHaderr() {
  ...
  return (
    <div className="relative before:w-full before:h-full before:bg-gradient-to-t from-[#0404044f] to-[#0a0a0b7c] before:absolute before:left-0 mb-2 border-b-2 border-gray-800 ">
      <img
