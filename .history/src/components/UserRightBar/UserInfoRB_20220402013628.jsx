...
export default function UserInfoRB() {
  return (
    <div className="flex flex-col justify-start items-start text-gray-500  dark:text-neutral-400">
      ...
      <p className="text-gray-600 font-semibold mb-5 dark:text-neutral-400">
        Hendrix Martin
      </p>
