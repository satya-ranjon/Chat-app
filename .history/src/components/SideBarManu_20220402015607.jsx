...
export default function SideBarManu() {
  ...
  return (
    <div className="sm:w-[75px] sm:h-screen bg-[#2e2e2e] flex sm:flex-col sm:justify-between mobile  flex-row w-full justify-center ">
      ...
      <div className="flex sm:flex-col sm:pl-0  flex-row pl-2 ">
        {theme === "dark" ? (
          <MdOutlineDarkMode
            color="#878a92"
            className="text-center  m-5 cursor-pointer mx-auto"
        ...
        <UserImage className="w-9 h-9 rounded-full mx-auto  m-5 border-2 border-[#4eac6d] sm:ml-0" />
      </div>
    </div>
  );
}
