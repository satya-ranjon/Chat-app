    ...
    <div className="sm:w-72 h-screen w-40 ">
      <div className="">
        <div className="relative mb-12">
          ...
          <p className=" absolute top-0 left-0 p-3 text-white font-semibold text-xl font-serif">
            My Profile
          </p>
        ...
        <p className="text-[18px] text-gray-600 text-center font-semibold font-sans">
          Kathryn Swarey
        </p>
