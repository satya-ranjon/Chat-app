  ...
  return (
    <div className="absolute bottom-0 min-w-full p-4 py-7 border-t-[1px] border-gray-200 ">
      <div className="grid grid-flow-col text-gray-500  ">
        ...
        <input
          className="col-start-3 col-span-12 bg-white outline-none p-2 px-4 rounded-md border-2 border-gray-300 dark:text-gray-300 dark:bg-neutral-700 dark:border-none"
          type="text"
