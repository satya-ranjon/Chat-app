...
export default function Login() {
  return (
    <div className="min-h-screen min-w-full p-10 flex justify-between bg-green-500">
      <div className="text-2xl flex justify-start">
        <BsChatSquareTextFill /> <p className="">Chat</p>
      </div>
      <div
        className="xl:w-[100rem] md:w-[80rem]  right-0 h-full  bg-neutral-800 rounded-2xl
      "
      ></div>
      <img
