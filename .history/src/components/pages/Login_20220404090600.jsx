...
export default function Login() {
  return (
    <div className="text-left text-neutral-400 font-semibold">
      ...
      <div className="flex ">
        <div className="w-full bg-neutral-500 h-[1px] my-auto"></div>
        <p className="w-full text-center">Sign in with</p>
        <div className="w-full bg-neutral-700 h-[1px] my-auto"></div>
      </div>
    </div>
  );
}
