...
export default function ChatHader() {
  ...
  return (
    <div className="px-5 pt-4">
      ...
      <input
        className="bg-slate-100 dark:bg-neutral-700 text-sm p-3 w-full m-5 mx-0 outline-none placeholder:text-slate-400 placeholder:font-semibold text-zinc-700"
        type="text"
