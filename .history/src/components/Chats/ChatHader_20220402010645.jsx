    ...
    <div className="px-5 pt-4">
      <div className="flex justify-between items-start">
        ...
        <div className="flex">
          ...
          <button
            className="bg-green-50 text-green-400 hover:bg-green-400 hover:text-white transition-colors duration-300 p-2 dark:bg-neutral-700 dark:hover:bg-green-400
          "
