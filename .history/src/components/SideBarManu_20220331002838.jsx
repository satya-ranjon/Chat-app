  ...
  return (
    <div className="w-14 h-screen bg-[#2e2e2e] flex flex-col justify-between">
      <div className="flex flex-col">
        ...
        <BiUserCircle
          color="#878a92"
          className="text-center m-4 cursor-pointer mx-auto border-r-4 border-[#4eac6d] bg-[#4eac6d] "
          size={24}
        />
        <TiMessages
          color="#878a92"
      ...
      <div className="flex flex-col">
        ...
        /> */}
        <img
          className="w-10 h-10 rounded-full mx-auto m-4 border-2 border-[#4eac6d]"
