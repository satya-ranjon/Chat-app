  ...
  return (
    <div className={className}>
      ...
      {array.map((i) => (
        <div
          key={i}
          className="flex justify-between dark:text-neutral-400 border-[1px] border-gray-100 p-3 my-2"
        >
          <AiOutlineFileText className="bg-green-200 dark:bg-green-800 p-1 dark:text-green-500  rounded-full text-2xl my-auto" />
